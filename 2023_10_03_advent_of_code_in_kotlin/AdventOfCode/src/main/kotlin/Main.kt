...
fun main(args: Array<String>) {
    ...
    val input = File("$folderPath/adventOfCode2023/day15.txt").readText();
...
//    print("time: $time")
    ...
    println(adventOfCode2023.day15_lens.puzzle1(input))
    println(adventOfCode2023.day15_lens.puzzle2(input))
