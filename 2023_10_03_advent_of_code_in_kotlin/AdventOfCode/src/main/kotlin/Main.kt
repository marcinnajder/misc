...
fun main(args: Array<String>) {
    ...
    val input = File("$folderPath/adventOfCode2023/day07.txt").readText();
...
//    print("time: $time")
    ...
    println(adventOfCode2023.day07_poker.puzzle1(input))
    println(adventOfCode2023.day07_poker.puzzle2(input))
