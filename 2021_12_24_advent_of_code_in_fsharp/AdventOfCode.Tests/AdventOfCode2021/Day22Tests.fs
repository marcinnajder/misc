...
type Day22Tests() =
    ...
    member this.areCubesOverlapping() =
        ...
        Assert.IsFalse(areCubesOverlapping cube1 cube2)
        Assert.IsFalse(areCubesOverlapping cube1 { cube2 with X = cube1.X })
        Assert.IsFalse(areCubesOverlapping cube1 { cube2 with X = cube1.X; Y = cube1.Y })
        Assert.IsTrue(areCubesOverlapping cube1 { cube2 with X = cube1.X; Y = cube1.Y; Z = cube1.Z })
